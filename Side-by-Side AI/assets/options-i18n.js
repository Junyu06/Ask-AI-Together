...
(function initOptionsI18n() {
  ...
  const MESSAGES = {
    zh: {
      ...
      retile: "重排",
      focus_first: "聚焦首个",
      close_targets: "关闭已开窗口",
      close_all_targets: "关闭全部已开窗口",
      refresh_state: "刷新状态",
      drag_sort: "拖拽排序",
      attachment_remove: "移除图片",
      ...
      settings_close_running: "正在关闭已绑定窗口…",
      settings_close_failed: "关闭失败：{reason}",
      settings_close_done: "已关闭 {count} 个已绑定标签页。",
    ...
    en: {
      ...
      settings_close_running: "Closing bound targets...",
      settings_close_failed: "Close failed: {reason}",
      settings_close_done: "Closed {count} bound tabs.",
